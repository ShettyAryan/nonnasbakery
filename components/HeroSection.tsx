...
export default function HeroSection() {
  return (
    <section className="bg-cream min-h-[92vh] flex items-center overflow-hidden relative">
      ...
      >
        <span
          className="font-serif text-[28vw] text-crimson/[0.04] whitespace-nowrap leading-none"
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-16 lg:py-20 w-full">
        {/* Left — Copy */}
        <div className="relative z-10">
          ...
          <FadeUp delay={450}>
            <p className="text-near-black/60 text-base lg:text-lg font-sans leading-relaxed max-w-md mb-8">
          ...
          <FadeUp delay={650}>
            <div className="flex flex-wrap gap-4 items-center">
              <button className="bg-crimson text-white px-8 py-4 rounded-full font-sans font-bold text-sm small-caps hover:bg-dark-maroon transition-colors duration-300 flex items-center gap-3 group">
                Shop Our Breads
                <svg
        ...
        <div className="relative h-[480px] lg:h-[640px]">
          {/* Main large bread */}
          <div className="absolute top-0 right-0 w-72 h-72 lg:w-96 lg:h-96 animate-float-1 z-20">
            <div
          ...
          {/* Cannoli bottom left */}
          <div className="absolute bottom-8 left-0 w-52 h-52 lg:w-64 lg:h-64 animate-float-2 z-30">
            <div
          ...
          {/* Flour bowl centre */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-36 h-36 lg:w-44 lg:h-44 animate-float-3 z-10 opacity-70">
          ...
          <div
            className="absolute top-12 left-4 bg-white/95 backdrop-blur-sm px-5 py-3 rounded-full shadow-lg border border-crimson/10 z-40"
            style={{ transform: "rotate(-3deg)" }}
          >
            <p className="text-crimson font-sans font-bold text-xs small-caps">
              100% Real Ingredients
            </p>
          </div>

          <div
            className="absolute bottom-36 right-4 bg-crimson text-white px-5 py-3 rounded-full shadow-lg z-40"
            style={{ transform: "rotate(4deg)" }}
          >
            <p className="font-sans font-bold text-xs small-caps flex items-center gap-1.5">
              Nonna Approved ✓
            </p>
          </div>
          ...
          <div className="absolute top-1/2 right-2 -translate-y-1/2 z-40">
            <div className="w-20 h-20 rounded-full stamp-border border-crimson/30 flex items-center justify-center text-center p-2">
              <div>
                <div className="font-serif text-crimson text-[10px] leading-tight">
                  EST.
                </div>
                <div className="font-serif text-crimson text-lg leading-none">
                  1982
                </div>
              </div>
            </div>
