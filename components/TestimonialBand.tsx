  ...
  return (
    <section className="px-6 lg:px-12 py-8">
      <div className="max-w-[1440px] mx-auto">
        <FadeUp>
          <div className="bg-raspberry rounded-2xl px-10 py-16 lg:px-20 lg:py-20 relative overflow-hidden group">
            ...
            <div className="absolute top-6 left-8 font-serif text-[160px] text-white/10 leading-none select-none pointer-events-none">
              &ldquo;
            </div>

            <div className="relative z-10 max-w-3xl">
              <h3 className="font-serif text-white text-3xl lg:text-5xl leading-[1.1] mb-8">
                Every loaf tastes like Sunday morning at my grandmother&apos;s
                house. Nothing compares.
              </h3>
              <p className="text-white/70 text-sm font-sans font-bold small-caps tracking-widest">
